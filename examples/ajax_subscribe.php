...
if ($isAjaxRequest && !empty($_POST)) {
    ...
    $endpoint   = new ListKingdomApi_Endpoint_ListSubscribers();
    ...
    if ($response->itemAt('status') == 'success') {
        exit(ListKingdomApi_Json::encode(array(
            'status'    => 'success',
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/riantoastono/listkingdom/master/site/bootstrap.css" />
    <link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/riantoastono/listkingdom/master/site/bootstrap-glyphicons.css" />
    <link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/riantoastono/listkingdom/master/site/style" />
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
    <script type="text/javascript" src="https://raw.githubusercontent.com/riantoastono/listkingdom/master/site/bootstrap.js" id="script-bootstrap"></script>
    <link rel="shortcut icon" href="https://raw.githubusercontent.com/riantoastono/listkingdom/master/site/favicon.ico" type="image/x-icon" />
...
<div class="col-lg-4" id="content">
    <!--
    The form below is generated by ListKingdomApi EMA.
