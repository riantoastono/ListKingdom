...
/**
 * ListKingdomApi_Cache_Apc makes use of the APC extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class ListKingdomApi_Cache_Apc extends ListKingdomApi_Cache_Abstract
{
    /**
