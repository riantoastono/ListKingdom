<?php
/**
 * This file contains the APC cache class used in the ListKingdomApi PHP-SDK.
 * 
...
/**
 * ListKingdomApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class ListKingdomApi_Cache_Xcache extends ListKingdomApi_Cache_Abstract
{
    /**
