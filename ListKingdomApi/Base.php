<?php
/**
 * This file contains the base class for the ListKingdomApi PHP-SDK.
 *
...
/**
 * ListKingdomApi_Base is the base class for all the other classes used in the sdk.
 * 
 * @author riantoastono <riantoastono@gmail.com>
 * @package ListKingdomApi
 * @since 1.0
 */
class ListKingdomApi_Base
{
    /**
    ...
    /**
     * @var ListKingdomApi_Config the configuration object injected into the application at runtime
     */
    private static $_config;
    
    /**
     * @var ListKingdomApi_Params the package registry that will hold various components
     */
    private static $_registry = array();
    
    /**
     * @var ListKingdomApi_Params the registered event handlers
     */
     ...
     * 
     * @param ListKingdomApi_Config $config
     */
    public static function setConfig(ListKingdomApi_Config $config)
    {
        self::$_config = $config;
    }
     ...
     * 
     * @return ListKingdomApi_Params
     */
    public function getRegistry()
    {
        if (!(self::$_registry instanceof ListKingdomApi_Params)) {
            self::$_registry = new ListKingdomApi_Params(self::$_registry);
        }
     ...
     * $components = array(
     *     'cache'=>array(
     *         'class'             => 'ListKingdomApi_Cache_Sqlite',
    ...
    public function setComponent($componentName, array $config)
    {
        ...
        if ($component instanceof ListKingdomApi_Base) {
    ...
    {
        if (!(self::$_eventHandlers instanceof ListKingdomApi_Params)) {
            self::$_eventHandlers = new ListKingdomApi_Params(self::$_eventHandlers);
        }
        
        if (!self::$_eventHandlers->contains($eventName) || !(self::$_eventHandlers->itemAt($eventName) instanceof ListKingdomApi_Params)) {
            self::$_eventHandlers->add($eventName, new ListKingdomApi_Params());
        }
