<?php
/**
 * This file contains the configuration class for the ListKingdomApi PHP-SDK.
 *
...
/**
 * ListKingdomApi_Config contains the configuration class that is injected at runtime into the main application.
 * 
 ...
 * @since 1.0
 */
class ListKingdomApi_Config extends ListKingdomApi_Base
{
    /**
