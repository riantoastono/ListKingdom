...
/**
 * ListKingdomApi_ParamsIterator implements an interator for {@link ListKingdomApi_Params}.
 *
 * It allows ListKingdomApi_Params to return a new iterator for traversing the items in the map.
 * 
 * @author riantoastono
 ...
 */
class ListKingdomApi_ParamsIterator implements Iterator
{
	/**
