<?php
/**
 * This file contains the ListKingdomApi_Http_Response class used in the ListKingdomApi PHP-SDK.
 * 
...
/**
 * ListKingdomApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author riantoastono <riantoastono@gmail.com>
 ...
 * @since 1.0
 */
class ListKingdomApi_Http_Response extends ListKingdomApi_Base
{
    /**
    ...
    /**
     * @var ListKingdomApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var ListKingdomApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var ListKingdomApi_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var ListKingdomApi_Http_Request
     */
    public $request;
     ...
     * Contructor.
     * 
     * @param ListKingdomApi_Http_Request $request
     */
    public function __construct(ListKingdomApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new ListKingdomApi_Params($params);
        }
