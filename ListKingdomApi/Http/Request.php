<?php
/**
 * This file contains the ListKingdomApi_Http_Request class used in the ListKingdomApi PHP-SDK.
 * 
...
/**
 * ListKingdomApi_Http_Request is the request class used to send the requests to the API endpoints.
 * 
 * @author riantoastono <riantoastono@gmail.com>
 ...
 * @since 1.0
 */
class ListKingdomApi_Http_Request extends ListKingdomApi_Base
{
    /**
     * @var ListKingdomApi_Http_Client the http client injected.
     */
    public $client;
    
    /**
     * @var ListKingdomApi_Params the request params.
     */
    public $params;
     ...
     * Constructor.
     * 
     * @param ListKingdomApi_Http_Client $client
     */
    public function __construct(ListKingdomApi_Http_Client $client)
    {
        $this->client = $client;    
    }
    ...
    public function send()
    {
        ...
        curl_setopt($ch, CURLOPT_USERAGENT , 'ListKingdomApi Client version '. ListKingdomApi_Http_Client::CLIENT_VERSION);
        ...
        if ($client->isPostMethod || $client->isPutMethod || $client->isDeleteMethod) {
            ...
            $params = new ListKingdomApi_Params($client->paramsPost);
        ...
        $params = $this->params = new ListKingdomApi_Params($curlInfo);
        ...
        if ($curlCode === 0 && $client->getResponseHeaders) {
            ...
            $params->add('headers', new ListKingdomApi_Params($headers));
        }
        
        $decodedBody = array();
        if ($curlCode === 0 && !empty($body)) {
            $decodedBody = ListKingdomApi_Json::decode($body, true);
        ...
        $params->add('body', new ListKingdomApi_Params($decodedBody));
        
        $response = new ListKingdomApi_Http_Response($this);
        $body = $response->body;
    ...
    protected function sign($requestUrl)
    {
        ...
        $params = new ListKingdomApi_Params($specialHeaderParams);
